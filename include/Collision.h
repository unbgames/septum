...
class Collision {
	...
	public:
		...
		static inline bool IsColliding (Rect& a, Rect& b, float angleOfA,
				float angleOfB) {
			Vec2 A[] = { Vec2(a.x, a.y + a.h), Vec2(a.x + a.w, a.y + a.h), Vec2(
					a.x + a.w, a.y), Vec2(a.x, a.y) };
			Vec2 B[] = { Vec2(b.x, b.y + b.h), Vec2(b.x + b.w, b.y + b.h), Vec2(
					b.x + b.w, b.y), Vec2(b.x, b.y) };
			...
			Vec2 axes[] = { Norm(A[0] - A[1]), Norm(A[1] - A[2]), Norm(
					B[0] - B[1]), Norm(B[1] - B[2]) };
